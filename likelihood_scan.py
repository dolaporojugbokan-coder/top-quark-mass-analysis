...
plt.legend()
plt.tight_layout()
plt.savefig(f"{HOME}/likelihood_plot1.png", dpi=150, bbox_inches='tight')
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig(f"{HOME}/likelihood_plot2.png", dpi=150, bbox_inches='tight')
plt.close()
...
for m_true, filename in zip(mass_list, file_list):
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(f"{HOME}/likelihood_plot1_{mass_str}.png", dpi=150, bbox_inches='tight')
    plt.close()
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(f"{HOME}/likelihood_plot2_{mass_str}.png", dpi=150, bbox_inches='tight')
    plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig(f"{HOME}/bias_plot.png", dpi=150, bbox_inches='tight')
plt.close()
