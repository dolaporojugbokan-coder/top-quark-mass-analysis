...
for bin in range(1, nbins+1):
    ...
    plt.savefig(f"/home/drojugbo/plot_bin{bin}.png")
    plt.close()

np.save("/home/drojugbo/slopes.npy", slopes)
np.save("/home/drojugbo/intercepts.npy", intercepts)
with open("/home/drojugbo/Param_mtop.txt", "w") as f:
